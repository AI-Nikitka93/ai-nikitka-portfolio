...
export default function NotFound() {
  return (
    ...
    >
      <div className="signal-surface max-w-3xl rounded-shell p-8 md:p-10">
        <p className="signal-label text-accent">404</p>
        <ScrambleText
          text="Страница не найдена."
          as="h1"
          className="mt-4 text-4xl font-semibold tracking-normal text-foreground md:text-5xl"
        />
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <Link
            href="/portfolio"
            className="inline-flex min-h-11 items-center rounded-panel border border-border-subtle bg-surface-muted px-5 py-3 text-sm font-medium text-foreground transition-colors hover:border-accent hover:text-foreground"
          >
            Смотреть работы
          </Link>
        </div>
