...
const timeline = [
  ...
  },
  {
    ...
    note: "Полноценный разворот после политически мотивированного увольнения. Системный сбор сертификатов (Vanderbilt, Google, IBM, Cisco) для быстрой адаптации в IT.",
    icon: Sliders,
  },
  {
    period: "2023",
            ...
            <div className="space-y-6">
              ...
              <div className="signal-frame rounded-panel p-5 md:p-6 bg-void-black/60 relative">
                ...
                <div className="mt-4 font-mono text-[10px] text-titanium space-y-2 leading-5">
                  ...
                  <p>&gt; load facts: &quot;О никите на 09.04.2026.txt&quot;</p>
